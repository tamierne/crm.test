            ...
            <div class="card card-info">
                ...
                <form class="form-horizontal" method="POST" action="{{ route('projects.update', $project->id) }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local" class="form-control" name="deadline" id="deadline" value="{{ $project->deadline }}">
                        </div>
                        <div class="form-group">
                ...
                <div class="card-body">
                    ...
                    @if (count($project->tasks) == 0)
                        <h5 class="card-title m-5">There're no tasks in this project</h5>
                    @else
                        <table class="table">
                            <thead>
                                <tr>
